...
const GPT = () => {
  ...
  const credit = useSelector((state) => state.user?.user?.credit);
  ...
  const handleSubmit = async(e) => {
    ...
    if (credit <= 0) {
      ...
      dispatch(
        setGPTMovies({ movieNames: [], movieResults:  [] })
      );
      hideLoading();
      return;
    }
  ...
  return (
    <>
      ...
      />
      {error && (
        <div className="absolute top-2/3 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white p-4 rounded-lg">
